...
-------------------------------------------------------------------------------------------------------------
The W3C Validator was used to validate and check for errors in the code

I developed the page mainly in Chrome. It was also tested and functioned in Firefox and Edge

Acknowledgements and Credits
------------------------------------------------------------------------------------------------------------

The Code Institute Lesson Guide was instrume